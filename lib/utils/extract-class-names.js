/**
 * Copied from https://github.com/tailwindlabs/tailwindcss-intellisense/blob/bdb398bf80a5557b329e5b1c7f2019c58e49cd00/packages/tailwindcss-language-server/src/lib/extractClassNames.ts
 */
...
async function process(root) {
  ...
  root.walk((node) => {
    if (node.type === 'comment') {
      let match = node.text
        .trim()
        .match(/^__tw_intellisense_layer_([a-z]+)__$/);
