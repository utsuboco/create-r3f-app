...
exports.aheadOfPublished = function () {
  ...
  The version of ${chalk.green('create-r3f-app')} you are
...
exports.help = function () {
  ...
  If you have any problems, do not hesitate to file an issue:
    ${chalk.cyan('https://github.com/utsuboco/create-r3f-app/issues/new')}
  `);
};
...
exports.start = function (projectName, type) {
  ...
  ${chalk.green('https://github.com/utsuboco/create-r3f-app/issues')}`);
};
